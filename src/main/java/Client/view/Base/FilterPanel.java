...
public class FilterPanel extends view.Base.Menu {
    public FilterPanel(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu disableFilter() {
        return new view.Base.Menu("Disable A Filter", this) {
            @Override
            public void show() {
            ...
            public void run() {
                ...
                int filterNumber = Integer.parseInt(view.Base.Main.scanInput("int"));
                while (filterNumber > AllProductsPanelController.getCurrentFilters().size() || filterNumber < 1) {
                    System.out.println("Invalid number, try again:");
                    filterNumber = Integer.parseInt(view.Base.Main.scanInput("int"));
                }
    ...
    private view.Base.Menu showCurrentFilter() {
        return new view.Base.Menu("Current Filters", this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
            }
    ...
    private view.Base.Menu filterAnAvailableFilter() {
        return new view.Base.Menu("Filter A Filter", this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
            ...
            public void run() {
                try {
                    ...
                    while (chosenNumber > 8 || chosenNumber < 1) {
                        System.out.println("Invalid number, try again");
                        chosenNumber = Integer.parseInt(view.Base.Main.scanInput("int"));
                    }
                    switch (chosenNumber) {
                        case 1:
                        ...
                        case 6:
                            ...
                            String input = view.Base.Main.scanInput("String");
                            while (!input.equalsIgnoreCase("yes") && !input.equalsIgnoreCase("no")) {
                                System.out.println("Invalid input, try again: (yes/no)");
                                input = view.Base.Main.scanInput("String");
                            }
                        ...
                        case 7:
                            ...
                            String categoryName = view.Base.Main.scanInput("String");
                            System.out.println("Enter name of the feature:");
                            String featureName = view.Base.Main.scanInput("String");
    ...
    private view.Base.Menu showAvailableFilters() {
