...
import view.Base.RegisterAndLoginPanel;

import java.util.HashMap;

public class CartPanel extends view.Base.Menu {
    public CartPanel(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu showProducts() {
        return new view.Base.Menu("Cart Products", this) {
    ...
    private view.Base.Menu viewProduct() {
    ...
    private view.Base.Menu increaseProduct() {
        return new view.Base.Menu("Increase Product", this) {
            ...
            public void run() {
                Product product = null;
                try {
                    view.Base.Menu menu = new view.Base.Menu("Select Seller", this) {
                        ...
                        @Override
                        public void run() {
                            int number = Integer.parseInt(view.Base.Main.scanInput("int"));
    ...
    private view.Base.Menu decreaseProduct() {
        return new view.Base.Menu("Decrease Product", this) {
    ...
    private view.Base.Menu showTotalPrice() {
        return new view.Base.Menu("Total Price", this) {
    ...
    private view.Base.Menu purchase() {
        return new Menu("Purchase", this) {
            ...
            public void run() {
                ...
                String address = view.Base.Main.scanInput("String");
                ...
                try {
                    ...
                    String saleCode = view.Base.Main.scanInput("String");
