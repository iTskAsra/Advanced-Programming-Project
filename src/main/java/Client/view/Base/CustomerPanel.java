...
import model.Sale;
import view.Base.CartPanel;
import view.Base.CustomerLogs;
...
public class CustomerPanel extends view.Base.Menu {
    public CustomerPanel(view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu showCustomerInfo() {
        return new view.Base.Menu("Show Customer Info", this) {
    ...
    private view.Base.Menu editCustomerInfo() {
        return new view.Base.Menu("Edit Customer Info", this) {
    ...
    private view.Base.Menu viewBalance() {
        return new view.Base.Menu("View Balance", this) {
    ...
    private view.Base.Menu viewDiscountCodes() {
