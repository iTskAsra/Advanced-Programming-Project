...
import model.Rate;
import view.Base.Digest;
import view.Base.Main;
import view.Base.Menu;
import view.Base.ProductCommentPanel;

import java.util.HashMap;

public class ProductPage extends view.Base.Menu {

    public ProductPage(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu compareProducts() {
        return new view.Base.Menu("Compare Products",this) {
            @Override
            public void show() {
    ...
    private view.Base.Menu attributes() {
