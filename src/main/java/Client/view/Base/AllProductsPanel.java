...
import view.Base.FilterPanel;
import view.Base.Main;
import view.Base.Menu;
import view.Base.ProductPage;
import view.Base.SortPanel;

import java.util.ArrayList;
import java.util.HashMap;

public class AllProductsPanel extends view.Base.Menu {
    public AllProductsPanel(view.Base.Menu parentMenu) {
    ...
    public view.Base.Menu viewCategories(){
        return new view.Base.Menu("View Categories",this) {
            @Override
            public void show() {
    ...
    public view.Base.Menu showProducts(){
        return new view.Base.Menu("Show Products",this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
            }
    ...
    public view.Base.Menu showProductDetails(){
        return new Menu("Show Product Details",this) {
            ...
            public void run() {
                ...
                try {
                    ...
                    view.Base.ProductPage productPage =new ProductPage(product.getName(),this.getParentMenu());
                    productPage.show();
                    productPage.run();
                } catch (ExceptionsLibrary.NoProductException e) {
                    System.out.println(e.getMessage());
