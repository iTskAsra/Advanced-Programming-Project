...
public class ProductCommentPanel extends view.Base.Menu {
    public ProductCommentPanel(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu showRate() {
        return new view.Base.Menu("Rate",this) {
            @Override
            public void show() {
    ...
    private view.Base.Menu addComment() {
        return new view.Base.Menu("Add Comment",this) {
            @Override
            public void show() {
            ...
            public void run() {
                ...
                String title = view.Base.Main.scanInput("String");
    ...
    private view.Base.Menu showAllComments() {
