...
public class ManageCategoriesMenu extends view.Base.Menu {
    public ManageCategoriesMenu(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu removeCategory() {
        return new view.Base.Menu("Remove Category",this) {
            @Override
            public void show() {
    ...
    private view.Base.Menu addCategory() {
        return new view.Base.Menu("Add Category",this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
            }
            ...
            public void run() {
                ...
                String features =  view.Base.Main.scanInput("String");
    ...
    private view.Base.Menu editCategory() {
        return new view.Base.Menu("Edit category info", this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
            }
    ...
    private view.Base.Menu showAllCategories() {
