...
public class ManageRequestsMenu extends view.Base.Menu {
    public ManageRequestsMenu(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu processRequest() {
        return new view.Base.Menu("Process Request", this) {
            @Override
            public void show() {
            ...
            @Override
            public void run() {
                int requestId = Integer.parseInt(view.Base.Main.scanInput("int"));
                try {
                    ...
                    String status = view.Base.Main.scanInput("String");
    ...
    private view.Base.Menu showRequestDetails() {
        return new view.Base.Menu("Request details", this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
                System.out.println("Enter request ID :");
    ...
    private view.Base.Menu showAllRequests() {
