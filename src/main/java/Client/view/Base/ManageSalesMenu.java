...
public class ManageSalesMenu extends view.Base.Menu {

    public ManageSalesMenu(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu removeSaleCode() {
        return new view.Base.Menu("Delete Sale", this) {
            @Override
            public void show() {
    ...
    private view.Base.Menu editSaleInfo() {
        return new view.Base.Menu("Edit Sale Info",this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
                System.out.println("Enter sale code :");
    ...
    private view.Base.Menu showSaleDetails() {
        return new view.Base.Menu("Sale Details",this) {
            @Override
            public void show() {
                System.out.println(this.getName() + ":");
                System.out.println("Enter sale code :");
    ...
    private view.Base.Menu showAllSales() {
