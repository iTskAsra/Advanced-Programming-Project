...
public class OffPanel extends view.Base.Menu {
    public OffPanel(view.Base.Menu parentMenu) {
    ...
    public view.Base.Menu showOffs(){
        return new view.Base.Menu("Show Offs",this){
            @Override
            public void show(){
    ...
    public view.Base.Menu goToProductPage(){
