...
public class Digest extends view.Base.Menu {
    public Digest(String name, view.Base.Menu parentMenu) {
    ...
    private view.Base.Menu selectSeller() {
        return new view.Base.Menu("Select Seller",this) {
    ...
    private view.Base.Menu addToCart() {
